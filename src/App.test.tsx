    ...
    const fetchMock = vi.fn((url: RequestInfo | URL) => {
      ...
      if (u.endsWith('manifest.json')) {
        return Promise.resolve(
          new Response(
            JSON.stringify({ lengths: [5], vocab: { 5: 3 }, tokenTotals: { 5: 100 }, meta: { alpha: 0.5, muFactorShort: 0.05, muFactorLong: 0.1, longThreshold: 8, tau: 1.0, builtAt: '2025-01-01T00:00:00Z' } }),
        ...
        return Promise.resolve(new Response(JSON.stringify({ abc: 0.34, abd: 0.33, abx: 0.33 }), { status: 200 }))
      }
